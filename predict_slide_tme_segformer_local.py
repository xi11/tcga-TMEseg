...
#segformer
model_checkpoint = r'W:\pipelines\TMEseg_tcga\model\mit-b3-finetuned-tmeTCGA-60-lr00001-s512-20x768'
model = TFAutoModelForSemanticSegmentation.from_pretrained(model_checkpoint)
save_dir = r'Z:\TIER2\anthracosis\never_smoker_multi\mit-b3-finetuned-tmeTCGA-60-lr00001-s512-20x768\mask_cws'
